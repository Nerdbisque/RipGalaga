...
namespace cse210_student_csharp_galaga
{
    ...
    public class Galaga
    {
        ...
        {
            // Set up variables and player logic
            ...
            //Set up the screen within raylib to allow player view.
            Raylib.InitWindow(ScreenWidth, ScreenHeight, "GALAGA");
            Raylib.SetTargetFPS(60);

            while (!Raylib.WindowShouldClose())
            {
                // This is the initial while loop that loops the game waiting for the window to close no new ending rn.
                Raylib.BeginDrawing();
    ...
    public class Player
    {
        ...
        public void Input()
        {
            // detect and move the player as part of the screen also based on speed as to make it easier to change later. 
        ...
        // Simple start game function waiting if a spacebar is pressesed then dont proceed.
    ...
    // This program runs off of frames and waits and commits action to each frame based on this step class.
    // Things usch as movement and interaction take place during this step class.
    public class Step
    {
        ...
        // here we have the player rectangle, item boxes for points as objects on the screen.
